...
<body>	
            <div class="container">
				<form class="normal" action="/food-c" method="post">
                {{csrf_field()}}
                    <table class="normal">
                        <tr>
                    ...
                    <table class="normal">
                        ...
                        <tr>
                            <td>Fuels & Oils- Heating or Cookig</td>
                            <td><input type="number" name=""/></td>
                            <td>
                                <select>
                                    <option value="per/m">BDT/month</option>
                        ...
                        <tr>
                            <td>Living Space Size</td>
                            <td colspan="2"><input type="number" placeholder="square ft." name="" value=""></td>
                        </tr>
                    </table>
